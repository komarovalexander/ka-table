...
const demos: Demo[] = [
  ...
  new Demo(PerformanceOptimizationDemo, '/performance-optimization', 'Memoization', 'PerformanceOptimizationDemo', 'https://stackblitz.com/edit/table-performance-optimization-js', 'https://stackblitz.com/edit/table-performance-optimization-ts', ''),
