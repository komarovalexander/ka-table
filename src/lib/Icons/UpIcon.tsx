...
export const UpIcon = ({ className }: { className: string}) => {
    return (
        <svg className={className} style={{transform: 'rotate(180deg)'}} xmlns='http://www.w3.org/2000/svg' version='1.1' id='Capa_1' x='0px' y='0px'  viewBox='0 -150 1024 1024'  width='10' height='10'>
            <g>
